...
@HiltViewModel
class MahasiswalViewModel @Inject constructor(private val mahasiswaRepository: MahasiswaRepository) : ViewModel()
{
    ...
    suspend fun insert(
        ...
        _isLoading.postValue(true)
        mahasiswaRepository.insert(
            npm, nama, tanggal_lahir, jenis_kelamin,
    ...
    suspend fun loadItem(id: String, onSuccess: (Mahasiswa?) ->
    Unit) {
    ...
    suspend fun update(
        ...
        mahasiswaRepository.update(
            id, npm, nama, tanggal_lahir, jenis_kelamin,
            onError = { item, message ->
                _toast.postValue(message)
                _isLoading.postValue(false)
            }, onSuccess = {
